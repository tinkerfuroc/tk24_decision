...
class Foo(py_trees.behaviour.Behaviour):
    ...
    def __init__(self, name):
        ...
        """
        # should contain no hardware connections that may not be there and no middleware connections that may not be there
    ...
    def setup(self):
        ...
        # loggers are only meant to be used for debugging purposes
    ...
    def update(self):
        ...
        if not ready_to_make_a_decision:
            ...
            # only send feedback message when something important happens
